...
// "Fresh Produce" regex
const freshProduceRegex = /\b(apples?|bananas?|oranges?|grapes?|cherr(y|ies)|peach(es)?|plums?|pears?|kiwis?|pineapples?|mangos?|melons?|cantaloupes?|lemons?|limes?|avocados?|tomato(s|es)?|cucumbers?|peppers?|carrots?|broccoli|cauliflower|spinach|kale|lettuce|arugula|beets?|radish(es)?|beans?|peas?|zucchini|eggplants?|potatoes?|onions?|garlic|corn|asparagus|brussels?| sprouts?|artichokes?|celery|mushrooms?|cabbage|bok choy|turnips?|parsnips?|chives?|dill|basil|cilantro|parsley|thyme|mint|tarragon|jicamas?|plantains?|lychee|persimmon|kumquat|guava|figs?|dates?|pomegranates?|carambola|buddha's hand|calamondin|yuzu|kohlrabi|celeriac|endive|edamame|chayote|lotus root|fiddleheads?|black truffles?|berr(y|ies)|blueberr(y|ies)|strawberr(y|ies)|vegetables?|greens|culinary herbs|sprouts|veggie|broccolini|tofu|papaya|chili|jackfruit|chesnuts?|nectarines?|durian|rhubarbs?|squash|jowar|cassava|guvar|jamun)\b/i

// "Meat & Seafood" regex
const meatProductsRegex = /\b(meat|beef|pork|chicken|turkey|lamb|goat|duck|venison|rabbit|bacon|ham|sausage|salami|prosciutto|chorizo|meatballs|steaks?|filet mignon|brisket|ribs|cutlets|tenderloin|crown roast|spareribs|taco meat|bologna|drumsticks?|thighs|fish|salmon|tuna|trout|cod|haddock|halibut|sardines?|mackerel|tilapia|catfish|shrimps?|prawns|lobster|crabs?|scallops|clams|oysters|mussels|squid|octopus|crawfish|langoustine|fish roe|caviar|sushi|ceviche|tartar|fish fillet|seafood|shellfish|whitefish|carp|bass|snapper|flounder|perch|barramundi|swordfish|mahi-mahi|rockfish|monkfish|grouper|anchovies|kelp|bisons?|elks?|wagyu|chops?|lamb|bear|tawook|kebobs?|kebabs?)\b/i

// "Dairy & Eggs" regex
const dairyProductsRegex = /\b(milk|cheese|yogurt|cream|cottage cheese|ricotta|mozzarella|parmesan|cheddar|gouda|brie|feta|provolone|mascarpone|kefir|gelato|eggs?|omelette|quiche|frittata|custard|soufflé|cheesecake|dairy|butter|falooda|lactose|rognoni|formaggi|guffanti|coconut)\b/i
...
// "Snacks & Sweets" regex
const snacksProductsRegex = /\b(chips|pretzels|popcorn|cakes?|nachos|cheese puffs|nuts?|trail mix|snacks?|bars?|chocolates?|brownies|cookies?|biscotti|macarons|meringues?|puddings?|gelato|sorbet|gum|bubblegum|cand(y|ies)?|lollipops|taffy|marshmallows?|snickers?|milky way|twix|kit kat|caramel|s'mores|churros|biscuits?|mini quiches|dried fruits?|motichur laddu|kulfi rolls?|rasgullas|burfi|gulab jamun|burger|dhoklas?|pakoras?|tikkis?|puri|jerky|gummies|cashews?|almonds?|peanuts?|falafel|aloe|mochi|kurkure|marmalades?)\b/i

// "Pantry & Essentials" regex
const pantryProductsRegex = /\b(oils?|vinegar|sauces?|ketchup|mustard|mayonnaise|salad|honey|agave nectar|sugar|powder|salt|black pepper|white pepper|cayenne pepper|paprika|cumin|oregano|basil|thyme|rosemary|sage|parsley|cilantro|ginger|turmeric|cinnamon|cloves|cardamom|extract|baking soda|yeast|flour|bread|cornstarch|rice|past(a|e)|quinoa|couscous|barley|cereal|lentils|chickpeas|jelly|jam|seeds?|coffee|tea|spices|pani puri|papri chaat|bhel puri|babaghanouj|lasagna|noodles?|olives?|pickles?|ramyun|ramen|buldak|kimchi|vermicellis?|miso|sambal|dal|wheat|chana|chutney|shan)\b/i
...
export const unitsRegex = /\b(\d+(\s+)?(\.|\-|x|×|\/)(\s+)?)?(\d+)(\s+)?(\/(\s+)?)?(kg|g|ea|ml|l|gm|pk|cnt|packs?|lb|lit(re|er)|piece|oz|cans?|pcs?|gr)\b/ig