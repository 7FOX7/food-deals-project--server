...
export type ProductData = {
    ...
    "The Healthy Cupboard": () => Products,     // no data for this store (100%) 
    "Costco Wholesale": () => Promise<Products>,
    "Brandon's No Frills": () => Promise<Products>,  
    "Pupo's Food Market": () => Products,       // no data for this store (100%)
    "The New Food Box": () => Promise<Products>,  
    "Kim's Variety": () => Products,             // no data for this store (100%)
    ...
    "Avondale": () => Products,          // no data for this store (100%)
