...
const productData: ProductData = {
    ...
    "Patty's Delights Peruvian Culinary": () => import("./scraping/Patty's Delights/data").then(mod => mod.default()),  
    ...
    "The Indian Valley": () => import("./scraping/The Indian Valley/data").then(mod => mod.default()),
