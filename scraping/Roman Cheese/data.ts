...
const getData = async (): Promise<Products> => {
    ...
    const addProducts = async (): Promise<Products> => {
        try {
            ...
            const response = await page.goto(`https://www.walmart.ca/en/search?q=roman%20cheese&typeahead=roman%20ch`, {
            ...
            console.error("Something went wrong (Roman Cheese): " + err.message)
