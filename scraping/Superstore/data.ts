...
const getData = async (): Promise<Products> => {
    ...
    const addProducts = async (pageNum: number): Promise<Products> => {
        ...
        try {
            ...
            const response = await page.goto(`https://www.realcanadiansuperstore.ca/en/food/c/27985?page=${pageNum}&promotions=Price+Reduction&promotions=Multi-Buy&promotions=Price+Reduction&promotions=Multi-Buy&promotions=Price+Reduction`, {
            ...
            console.error("Something went wrong (Superstore): " + err.message)
